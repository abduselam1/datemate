            ...
            <div class="absolute top-0 left-auto mx-auto  pb-4  h-full w-full">
                <div class="grid grid-cols-5 sm:max-w-2xl md:max-w-2xl xl:max-w-4xl h-full mx-auto border rounded dark:bg-black border-gray-300 dark:border-gray-600">
                    <div :class="{'col-span-5  sm:col-span-2':!messageSelected,'hidden sm:block col-span-2':messageSelected}" class=" overflow-y-auto overflow-x-hidden w-full col-span-5 sm:col-span-2 border-r border-gray-200 dark:border-gray-600">
                        <div class="sticky top-0 py-4 px-2 border-b border-gray-300 dark:border-gray-600  flex justify-between items-center">
                        ...
                        <div class="pb-10 sm:pb-0">
                            ...
                            <div class="flex items-center justify-start py-2 w-full  mt-1 px-1 cursor-pointer hover:rounded-lg hover:bg-gray-200 dark:hover:bg-gray-900 ">
                                ...
                                <div class="flex-none h-16 w-16 mr-2 rounded-full overflow-hidden">
                            ...
                            <div class="flex items-center justify-start py-2 w-full  mt-1 px-1 cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-900 ">
                                <!-- profile image of each message room -->
                                <div class="flex-none h-16 w-16 mr-2 rounded-full overflow-hidden">
                    ...
                    <div :class="{'relative overflow-auto w-full h-full pb-9  sm:pb-3':true,'flex place-items-center mx-auto col-span-3':!messageSelected,'col-span-5 w-full  sm:col-span-3':messageSelected}">
                        <div v-if="messageSelected" class="sticky top-0 py-4 px-2 border-b border-gray-300 dark:border-gray-600 flex justify-between items-center">
                        ...
                        <div class="h-full sm:px-3 px-2">
                            ...
                            <div v-show="messageSelected" class="  sticky border dark:border-gray-600 rounded-full w-full bottom-0 left-0 grid grid-cols-12 items-center ">
                            ...
                            <div v-show="!messageSelected" class="hidden sm:flex flex-col justify-center h-full w-full">
                                ...
                                <span class="text-center pt-2 text-gray-500 font-semibold text-xl">No chat selected</span>
