    ...
    <div class="dark:bg-black/90 bg-gray-50  col-span-5 sm:col-span-4 w-full md:pt-5 h-screen overflow-hidden">
        <div class="relative w-full h-full overflow-y-scroll">
            <div class="absolute top-0 left-auto mx-auto  pb-4  h-full w-full">
                <div
                    class="grid grid-cols-5 sm:max-w-2xl md:max-w-2xl xl:max-w-4xl h-full mx-auto border rounded dark:bg-black border-gray-300 dark:border-gray-600">
                    <div :class="{ 'col-span-5  sm:col-span-2': !messageSelected, 'hidden sm:block col-span-2': messageSelected }"
                        class=" overflow-y-auto overflow-x-hidden w-full col-span-5 sm:col-span-2 border-r border-gray-200 dark:border-gray-600">
                        <div
                            class="sticky dark:bg-black bg-gray-50 top-0 py-4 px-2 border-b border-gray-300 dark:border-gray-600  flex justify-between items-center">
                            <router-link to="/" class="block sm:hidden">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 dark:text-gray-300 text-gray-600"
                        ...
                        <div class="pb-10 sm:pb-0">
                            <!-- messages list -->
                            <div
                                class="flex items-center justify-start py-2 w-full  mt-1 px-1 cursor-pointer hover:rounded-lg hover:bg-gray-200 dark:hover:bg-gray-900 ">
                                ...
                                <div class="w-full overflow-hidden">
                                    ...
                                    <div class=" truncate text-sm text-gray-700 dark:text-gray-400 ">
                                        <span class="">last sent adaf adfjf adjfasdkff adfjfa adfd fsd asddjd djffj djdj
                                            ddk</span>
                                    </div>
                                </div>
                    ...
                    <div ref="chatList"
                        :class="{ 'relative overflow-hidden w-full h-full pb-9 flex flex-col  sm:pb-0': true, 'flex place-items-center mx-auto col-span-3': !messageSelected, 'col-span-5 w-full  sm:col-span-3': messageSelected }">
                        <div v-if="messageSelected"
                            class=" backdrop-filter backdrop-blur-xl opacity-80 dark:bg-black bg-gray-50 top-0 py-4 px-2 border-b border-gray-300 dark:border-gray-600 flex justify-between items-center">
                        ...
                        <div class="relative h-full w-full sm:px-3 px-2 overflow-auto ">
                            ...
                            <ul v-show="messageSelected" class=" h-full ">
                                <li class=" my-3 flex items-end">
                                    <span
                                        class="text-sm bg-gray-300 dark:bg-gray-800 text-gray-300 px-2 py-3 rounded-t-full rounded-br-full mt-2">hey
                                        everyoneeee</span>
                                </li>
                                <li class="my-2  text-right flex justify-end  text-gray-200">
                                    <span
                                        class="text-sm bg-brand/10 text-brand font-semibold py-3 rounded-t-full rounded-bl-full px-2 mt-2   ">
                                        hey how you doin
                                    </span>
                                </li>
                                <li class=" my-3">
                                    <span
                                        class="text-sm bg-gray-300 dark:bg-gray-800 text-gray-300 px-2 py-3 rounded-full mt-2">hey
                                        everyone</span>
                                </li>
                                <li class="my-2  text-right  text-gray-200">
                                    <span
                                        class="text-sm bg-brand/10 text-brand font-semibold py-3 rounded-full px-2 mt-2   ">
                                        hey how you doin
                                    </span>
                                </li>
                                <li class=" my-3">
                                ...
                                <li class=" my-3">
                                    <span
                                        class="text-sm bg-gray-300 dark:bg-gray-800 text-gray-300 px-2 py-3 rounded-full mt-2">heyy
                                        everyone</span>
                                </li>
                                <li class="my-2  text-right  text-gray-200">
                                    <span
                        ...
                        <div v-show="!messageSelected" class="hidden  sm:flex flex-col justify-center h-full w-full">
                            <div class="flex justify-center w-full">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="h-14 w-14 dark:text-gray-400 text-gray-700" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z" />
                                </svg>
                            </div>
                            <span class="text-center pt-2 dark:text-gray-400 text-gray-500 font-bold text-2xl">Your
                                messages</span>
                            <span class="text-center pt-2 dark:text-gray-400 text-gray-500 font-semibold text-sm">No
                                chat selected</span>
                    ...
                    <div v-show="messageSelected"
                        class="sticky px-1 z-20 bg-black  w-full py-3 bottom-0 right-0 left-0 ">
                        ...
                        <div class=" border  dark:border-gray-600 rounded-full w-full grid grid-cols-12 items-center ">
                            ...
                            <div class=" pl-1 w-full flex justify-center cursor-pointer text-center  col-span-1">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 text-yellow-700 h-6">
                            ...
                            <div class=" pl-2 py-1 col-span-10 w-full">
                                <input type="text" placeholder="Message"
                                    class="  w-full focus:outline-none dark:bg-transparent rounded text-gray-700 dark:text-gray-400  px-2 py-1"
                                    id="">
                            </div>
                            <div class=" col-span-1 text-center flex cursor-pointer justify-center w-full">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 text-brand h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
