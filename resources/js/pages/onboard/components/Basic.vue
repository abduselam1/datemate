        ...
        <div class="w-full h-full " >
            ...
            <div class="mt-3 md:flex block">
                ...
                <div class="block w-full mr-2">
                    ...
                    <select v-model="country" id="country" class="input mt-2 block border-gray-300 bg-gray-50">
                        <option value="">Choose your country</option>
                        
                            <option v-for="ctry in countries " :key="ctry" value="{{$}}">{{ $country }}</option>
            ...
            <div class="mt-3">
                <x-datepicker label="Date of birth" v-model="dataOfBirth" />            
