<template>
    <div class="mx-auto sm:max-w-lg max-w-md w-full rounded-xl shadow-md bg-white mt-16 pt-20">
            <!-- The form field -->
            <form class="mb-10 mx-10" @submit.prevent="change">
                ...
                <div class="my-3">
                    <div class="mb-5">
                        ...
                        <input type="new-password" name="new-password" id="new-password" ref="new-password" class="input block mt-3 px-3 py-1 text-gray-800 w-full" placeholder="********">
                    </div>
                    <div class="mb-5">
                        <label for="re-password" class=" text-light font-semibold">Re-type password</label>
                        <input type="re-password" name="re-password" id="re-password" ref="new-password" class="input block mt-3 px-3 py-1 text-gray-800 w-full" placeholder="********">
                    </div>
