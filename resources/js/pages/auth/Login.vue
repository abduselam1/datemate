    ...
    <div class="mx-auto md:max-w-4xl sm:max-w-lg max-w-md w-full rounded-xl shadow-md bg-white sm:mt-16">
        <div class="grid md:grid-cols-2 grid-cols-1">
            ...
            <form class="mt-20 mb-10 mx-10" @submit.prevent="login">
                <h2 class=" text-3xl text-light font-bold">Wellcome Back</h2>
                ...
                <div class="flex justify-center">
                    <span class="text-center text-gray-400 font-semibold text-sm">Don't have and Account? <router-link class=" text-brand" :to="{'name':'register'}">Register</router-link></span>
                </div>
            </form>
