                ...
                <div x-click='isInputOpen = !isInputOpen' class="flex">
                    ...
                    <div class="flex mb-1 mr-1">
                        <div class="px-2 py-1 bg-brand opacity-50 flex items-center rounded-full text-dark">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white cursor-pointer" wire:click='removeLanguage({{$language['id']}})' fill="none" viewBox="0 0 24 24" stroke="currentColor">
